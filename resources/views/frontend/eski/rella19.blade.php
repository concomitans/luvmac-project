...
@section('content')
    <div class="proje-kategorileri">
        ...
        <div class="container">
            <ol class="breadcrumb">
                <li><a href="rella19">Peanut Caramel Kek
                    </a></li>
        ...
        <div class="container">
            ...
            <div class="col-md-8 col-md-offset-1 sayfa-icerik">
                <h3 class="sayfa-baslik">Peanut Caramel Kek
                </h3>
                                            ...
                                            <div class="carousel slide" id="myCarousel">
                                                ...
                                                <div class="carousel-inner ">
                                                    <div class="active item img-responsive center-block" data-slide-number="0">
                                                        <img src="uploads/photos/proje-kategori/rella18.jpg"></div>
                                ...
                                <ul class="hide-bullets">
                                    <li class="col-sm-4 p0">
                                        <a id="carousel-selector-0">
                                            <img src="uploads/photos/proje-kategori/rella18.jpg" class="img-responsive">
                                        </a>
                                    </li>
