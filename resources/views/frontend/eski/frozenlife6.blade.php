...
@section('content')
    <div class="proje-kategorileri">
        ...
        <div class="container">
            <ol class="breadcrumb">
                <li><a href="frozenlife6">Frozen life patmax düz kesim 9*9</a></li>
        ...
        <div class="container">
            ...
            <div class="col-md-8 col-md-offset-1 sayfa-icerik">
                <h3 class="sayfa-baslik">Frozen life patmax
                    düz kesim 9*9</h3>
                <div class="proje-detay col-md-12">
                                            ...
                                            <div class="carousel slide" id="myCarousel">
                                                ...
                                                <div class="carousel-inner ">
                                                    <div class="active item img-responsive center-block" data-slide-number="0">
                                                        <img src="uploads/photos/proje-kategori/patmax9.png"></div>
                                ...
                                <ul class="hide-bullets">
                                    <li class="col-sm-4 p0">
                                        <a id="carousel-selector-0">
                                            <img src="uploads/photos/proje-kategori/patmax9.png" class="img-responsive">
                                        </a>
                                    </li>
                    ...
                    <div class="col-md-7 proje-aciklama">
                        <h4 class="proje-isim">Frozen life patmax
                            düz kesim 9*9</h4>
