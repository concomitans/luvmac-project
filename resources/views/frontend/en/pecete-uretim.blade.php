...
@section('meta')
    ...
    <title>Luvian Machinery | Peçete Üretim Makinaları</title>
@endsection
@section('content')
    <div class="proje-kategorileri">
        ...
        <div class="container">
            <ol class="breadcrumb">
                <li><a href="pecete-uretime">peçete üretim makinaları</a></li>
        ...
        <div class="container">
            <div class="col-md-3 sidebar-baslik">
                ...
                <ul>
                    ...
                    <li class="active"><a href="dondurulmus-patatesler">Peçete Üretim Makinaları</a></li>
                    <li class="passive"><a href="paketleme">Paketleme Grubu</a></li>
                    <li><a href="yedek-parca">Yedek Parçalar</a></li>
                    <li class="passive"><a href="ikinci-el">İkinci El</a></li>
                </ul>
