...
<head>
    @php
        ...
        $cssPath = $cssPath ?? asset('frontend/_css/style.css');
        $jsPath = $jsPath ?? asset('frontend/_js/app.js');
    @endphp
    ...
    <link href="{{ asset('/frontend/_css/bootstrap.css') }}" rel="stylesheet">
    <link href="{{ asset('/frontend/_css/style.css') }}" rel="stylesheet">
