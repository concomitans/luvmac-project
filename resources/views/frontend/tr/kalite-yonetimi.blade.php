...
@section('meta')
    ...
    <title>Luvian Machinery Kalite Yönetimi</title>
@endsection
@section('content')
    ...
    <div class="container">
        <div class="col-md-3 sidebar-baslik">
            ...
            <ul>
                <li class="passive"><a href="hakkimizda">Hakkımızda</a></li>
				<li class="active"><a href="misyon-vizyon">Misyon & Vizyon</a></li>
				<li class="passive"><a href="kalite-yonetimi">Kalite Yönetimi</a></li>
            </ul>
...
<div class="col-md-8 col-md-offset-1 sayfa-icerik">
    ...
    <p>
    Sürekli araştırma ve geliştirme yapan genç ve dinamik ekibimizle düşük maliyetli yüksek teknolojili ve kaliteli ürünlerin tedariğini sağlayan karlı bir kuruluş olmak ve ülkemizin gelişmesine katkı sağlayan küresel çözümler üreterek sektöründe lider,dünya çapında da tanınmış bir marka olmak.
    </p>
</div>
    </div>
