...
@section('content')
    <div class="proje-kategorileri">
        ...
        <div class="container">
            <ol class="breadcrumb">
                <li><a href="rella33">Küp Rende Mozarella
                    </a></li>
        ...
        <div class="container">
            ...
            <div class="col-md-8 col-md-offset-1 sayfa-icerik">
                <h3 class="sayfa-baslik">Küp Rende Mozarella
                </h3>
                <div class="proje-detay col-md-12">
                                            ...
                                            <div class="carousel slide" id="myCarousel">
                                                ...
                                                <div class="carousel-inner ">
                                                    <div class="active item img-responsive center-block" data-slide-number="0">
                                                        <img src="uploads/photos/proje-kategori/rella32.png"></div>
                                ...
                                <ul class="hide-bullets">
                                    <li class="col-sm-4 p0">
                                        <a id="carousel-selector-0">
                                            <img src="uploads/photos/proje-kategori/rella32.png" class="img-responsive">
                                        </a>
                                    </li>
                    ...
                    <div class="col-md-7 proje-aciklama">
                        ...
                        ÜRÜN GRAMAJ BİLGİSİ<br>
                        Adet Ambalaj Gramajı	: 2000 gr<br>
                        Koli İçi Adet	: 6 Paket<br><br>
                        SAKLAMA KOŞULLARI:<br>
                        Min. -18 °C de muhafaza ediniz. Çözündükten sonra tekrar dondurmayınız.<br><br>

                        KULLANIM ÖNERİSİ:<br>
                        Kullanmadan 24 saat önce + 4 °C de çözdürünüz.<br><br>

                        Çözünmüş ürünleri  buz dolabı koşullarında (+4 °C ) 1 hafta kullanabilirsiniz.<br>

                        RAF ÖMRÜ:
                        Min. -18  °C   de   1 Yıl.<br>
                        Max. + 4 °C    de  7 Gün.<br>
                    </div>
                </div>
                <div class="col-md-12">
                ...
                <div class="col-md-4 col-sm-6 col-xs-12 text-center">
                    <div class="proje">
                        ...
                        <a href="rella23"><img src="uploads/photos/proje-kategori/rella22.jpg" class="img-responsive center-block" alt=""></a>
                        <div class="aciklama">
                            <a href="#"></a>
                        </div>
                        <a href="#" class="siparisver pull-left">sipariş ver</a>
                        <a href="rella23" class="detayliincele pull-right">detaylı incele</a>
                    </div>
