...
@section('meta')
    ...
    <title>Luvian Machinery | Paketleme</title>
@endsection
@section('content')
        ...
        <div class="container">
            <div class="col-md-3 sidebar-baslik">
                ...
                <ul>
                    ...
                    <li class="active"><a href="paketleme">Paketleme Grubu</a></li>
 ...
 <div class="col-md-4 col-sm-6 col-xs-12 text-center">
  <div class="proje">
    <div class="proje-isim">
      <a href="movablejaw-skh650" style="display: block; height: 100%;">
        Hareketli Çene Shrink Paketleme Makinası (SKH 650)
      </a>
    </div>
    <a href="movablejaw-skh650" class="image-container">
      <img src="uploads/photos/proje-kategori/rella2.jpg" class="img-responsive center-block" alt="" style="max-height:180px;width:auto;">
    </a>
    <div class="aciklama">
      <a href="movablejaw-skh650"></a>
    </div>
    <div class="button-container">
      <a href="#" class="siparisver">sipariş ver</a>
      <a href="movablejaw-skh650" class="detayliincele">detaylı incele</a>
    </div>
  </div>
</div>
 <div class="col-md-4 col-sm-6 col-xs-12 text-center">
  <div class="proje">
    <div class="proje-isim">
      <a href="automaticlcut-t450" style="display: block; height: 100%;">
        Otomatik L Kesim Shrink Paketleme Makinası ( T 450 )
      </a>
    </div>
    <a href="automaticlcut-t450" class="image-container">
      <img src="uploads/photos/proje-kategori/rella2.jpg" class="img-responsive center-block" alt="" style="max-height:180px;width:auto;">
    </a>
    <div class="aciklama">
    ...
    <div class="button-container">
      <a href="#" class="siparisver">sipariş ver</a>
      <a href="automaticlcut-t450" class="detayliincele">detaylı incele</a>
    </div>
  </div>
</div>
 <div class="col-md-4 col-sm-6 col-xs-12 text-center">
